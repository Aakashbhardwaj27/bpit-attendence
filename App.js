...
export default function App() {
  ...
  if (!authenticated) {
    ...
    return <View style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <View style={{ margin: 50 }}><Text style={{ color: 'pink', fontWeight: 'bold', fontSize: 19 }}>BPIT SMART ATTENDENCE</Text>
          <Text style={{ color: 'blue', fontWeight: '700', fontSize: 12 }}>Powered by A.I.</Text>
        </View>
        <Image source={require('./assets/login.jpeg')} style={{ width: 300, height: 300 }} />
        ...
        {showLoginform ? <TouchableOpacity onPress={loginHandler} style={{ backgroundColor: 'pink', width: '80%', padding: 10, borderRadius: 30, shadowColor: 'grey', shadowOpacity: 0.7, margin: 15 }}>

          <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 19, textAlign: 'center' }}>Login Now</Text></TouchableOpacity>

          : <TouchableOpacity style={{ backgroundColor: 'pink', width: '80%', padding: 10, borderRadius: 30, shadowColor: 'grey', shadowOpacity: 0.7, margin: 15 }} onPress={()=>signupHandler()}>
  ...
  return (
    <View style={styles.container}>
      {!success && <View style={{ margin: 50 }}><Text style={{ color: 'pink', fontWeight: 'bold', fontSize: 19 }}>BPIT SMART ATTENDENCE</Text>
        <Text style={{ color: 'blue', fontWeight: '700', fontSize: 12 }}>Powered by A.I.</Text>
      </View>}
      <StatusBar style="auto" backgroundColor='pink' />
      {success ?<View style={styles.carboxSuccess}><View style={{ margin: 50 }}>
        ...
        <Text style={{ color: 'pink', fontWeight: 'bold', fontSize: 19 }}>BPIT SMART ATTENDENCE</Text>
        <Text style={{ color: 'blue', fontWeight: '700', fontSize: 12 }}>Powered by A.I.</Text>
      </View>
